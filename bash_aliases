...
alias ssh-testing='ssh alto@testing'
alias ssh-apps='ssh alto@apps'
alias ssh-production='ssh alto@production'
...
alias datastore-rezervace-novy='pyenv activate django3.6 && cd ~/Projects/alto/python/django/datastore-rezervace'
alias datastore-objednavky='pyenv activate django3.6 && cd ~/Projects/alto/python/django/datastore-objednavky'
...
alias datastore-rezervace='pyenv activate tornado3.6 && cd ~/Projects/alto/python/tornado/datastore-rezervace'
